...
namespace NSUNS4_Character_Manager
{
    public class XfbinParser
    {
        ...
        {
            return Main.b_byteArrayToIntRev(Main.b_ReadByteArray(fileBytes, 0x1C, 4));
        }
        ...
        {
            return Main.b_byteArrayToIntRev(Main.b_ReadByteArray(fileBytes, 0x2C, 4));
        }
        ...
        {
            return Main.b_byteArrayToIntRev(Main.b_ReadByteArray(fileBytes, 0x40, 0x4));
        }
